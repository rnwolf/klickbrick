...
'''
typer klickbrick.app utils docs --name awesome-cli --output help.md
'''
...
pytest --cov=klickbrick tests # Look for 100% coverage

Pin point which parts of the code are NOT covered by a test.

pytest --cov-report term-missing:skip-covered --cov=klickbrick .\tests\
...
typer klickbrick.klickbrick utils docs --name klickbrick --output docs/autodoc.md
...
https://rnwolf.github.io/klickbrick/
